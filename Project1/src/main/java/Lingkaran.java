...
public class Lingkaran extends javax.swing.JFrame {
     ...
     */
    double jariJari, phi,luas, keliling; 
    public Lingkaran() {
        initComponents();
    }
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(jari, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(32, 32, 32)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String nilaiX = jari.getText();
        jariJari = Double.parseDouble(nilaiX);
        phi = 3.14;
        keliling = 2 * phi * jariJari;
        luas = phi * jariJari * jariJari;
        
        txtKel.setText(String.valueOf(keliling) + " cm");
        txtLuas.setText(String.valueOf(luas) + " cm2");
